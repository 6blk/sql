...
VALUES(25, 'Oranges', 'large',  1, 'kg' , CURRENT_TIMESTAMP)
	 ,(26, 'Cucumbers', 'small',  1, 'kg' , CURRENT_TIMESTAMP);
...
(
	...
	(
		...
		FROM
		(
			SELECT p.product_id, vi.vendor_id, quantity, market_date
				,ROW_NUMBER() OVER (PARTITION  BY vendor_id, p.product_id ORDER BY market_date DESC) as quantity_rank
			FROM product as p
